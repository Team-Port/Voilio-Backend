 ...
 public class ChatRoomController {
  ...
  public ResponseEntity<ResultsResponse> findChatRoomByName(@PathVariable(value = "chatRoomName") String chatRoomName){
  ...
  public ResponseEntity<ResultsResponse> findChatRoomById(@PathVariable(value = "chatRoomId") Long chatRoomId){
