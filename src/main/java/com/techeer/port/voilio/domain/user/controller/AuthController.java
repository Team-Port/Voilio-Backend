...
public class AuthController {
    ...
    public ResponseEntity<ResultResponse<UserResponse>> signup(@RequestBody UserRequest userRequest) {
        ...
        ResultResponse<UserResponse> resultResponse = new ResultResponse<>(USER_REGISTRATION_SUCCESS, userResponse);
        resultResponse.add(
                linkTo(methodOn(AuthController.class).signup(userRequest)).withSelfRel());
